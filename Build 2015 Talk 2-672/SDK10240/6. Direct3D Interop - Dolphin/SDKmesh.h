...
protected:
    ...
    virtual HRESULT CreateFromMemory(
        ID3D11Device * pDev11,
        BYTE * pData,
        UINT DataBytes,
    ...
    void SwapVertexBufferHeaderArray(
        SDKMESH_VERTEX_BUFFER_HEADER * pVertexBufferHeaderArray,
        DWORD dwArrayLength);

    void SwapIndexBufferHeaderArray(
        SDKMESH_INDEX_BUFFER_HEADER * pIndexBufferHeaderArray,
        DWORD dwArrayLength);
    ...
    void SwapSubsetArray(
        SDKMESH_SUBSET * pSubsetArray,
        DWORD dwArrayLength);

    void SwapFrameArray(
        SDKMESH_FRAME * pFrameArray,
        DWORD dwArrayLength);

    void SwapMaterialArray(
        SDKMESH_MATERIAL * pMaterialArray,
        DWORD dwArrayLength);
...
private:
    // Pointers to the two chunks of data loaded in from the mesh file
